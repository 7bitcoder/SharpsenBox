...
namespace bc {
	lb::ILoadingBar* bc::Get< lb::ILoadingBar>::component_ = nullptr;
}
namespace lb {
	LoadingBar::LoadingBar() :bc::Get<ILoadingBar>(this) {}
	...
	void LoadingBar::init() {
		auto* ob = dynamic_cast<QObject*> (&bc::Get < im::IInstalationManager > ::get());
